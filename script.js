// document.getElementById("btn").percentage():
function gotosem4() {
...
function percentage() {
    ...
    let total = sub11 + sub22 + sub33 + sub44 + sub55 + sub66 + sub77 + sub88 + sub99;
    let percentage = total/9;
    let marks = [sub11, sub22, sub33, sub44, sub55, sub66, sub77, sub88, sub99]

    for (let m of marks) {
        if(m < 0 || m > 100) {
            alert("Enter the marks in Range of 1 to 100");
            return;
        }
    }
    ...
    "Name : " + name1 + "<br>" + "Total marks : " + total + "/900"  +  "<br>" + "Percentage : " + percentage.toFixed(2) + "%" + "<br>"
    + "Grade : " + grade +  "<br>" + "SGPA : " + sgpa.toFixed(2);
